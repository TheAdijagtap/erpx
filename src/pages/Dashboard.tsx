      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-accent/5 py-20 px-6">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center space-y-6 animate-fade-in">
            <div className="mb-6">
              <img src="https://cdn.builder.io/api/v1/image/assets%2Fc53d55d6e77f4fc3a0917324bbf678cd%2F499b782c908b4381899ecd66fa4267f4?format=webp&width=800" alt="CORS Logo" className="h-20 mx-auto object-contain" />
            </div>
