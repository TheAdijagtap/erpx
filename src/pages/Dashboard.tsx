      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-accent/5 py-20 px-6">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center space-y-6 animate-fade-in">
            <div className="mb-6">
              <img src="/assets/erpace-logo.png" alt="ERPace Logo" className="h-20 mx-auto object-contain" />
            </div>
          ...
          <div className="space-y-4">
            <Card className="p-6 hover:shadow-[var(--shadow-medium)] transition-[var(--transition-smooth)]">
              <details className="cursor-pointer">
                ...
                <p className="text-muted-foreground text-sm mt-4">
                  ERPace is designed for quick setup. You can start in minutes by configuring your business details, adding suppliers, and creating your first inventory items. Most businesses are fully operational within 30 minutes.
                </p>
              </details>
            </Card>
            ...
            <Card className="p-6 hover:shadow-[var(--shadow-medium)] transition-[var(--transition-smooth)]">
              <details className="cursor-pointer">
                ...
                <p className="text-muted-foreground text-sm mt-4">
                  Yes, ERPace is fully GST compliant for Indian businesses. All invoices and receipts automatically calculate GST based on your configured rates, and you can generate compliant tax reports.
                </p>
              </details>
            </Card>
            ...
            <Card className="p-6 hover:shadow-[var(--shadow-medium)] transition-[var(--transition-smooth)]">
              <details className="cursor-pointer">
                ...
                <p className="text-muted-foreground text-sm mt-4">
                  There are no limits on the number of items, suppliers, or transactions you can manage. ERPace scales with your business from small operations to large enterprises.
                </p>
              </details>
            </Card>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            <Card className="p-8 hover:shadow-lg transition-shadow border-2 border-border">
              <div className="text-center">
                ...
                <Button asChild className="w-full" size="lg">
                  <a href="mailto:necrus@yahoo.com?subject=ERPace%20Monthly%20Subscription&body=Hi%2C%20I%20would%20like%20to%20subscribe%20to%20the%20ERPace%20Monthly%20Plan%20(%E2%82%B9250%2Fmonth).%20Please%20share%20the%20payment%20details.">Get Started</a>
                </Button>
              </div>
            </Card>
            ...
            <Card className="p-8 hover:shadow-lg transition-shadow border-2 border-primary relative overflow-hidden">
              ...
              <div className="text-center">
                ...
                <Button asChild className="w-full" size="lg">
                  <a href="mailto:necrus@yahoo.com?subject=ERPace%20Yearly%20Subscription&body=Hi%2C%20I%20would%20like%20to%20subscribe%20to%20the%20ERPace%20Yearly%20Plan%20(%E2%82%B92%2C500%2Fyear).%20Please%20share%20the%20payment%20details.">Get Started</a>
                </Button>
              </div>
            </Card>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="p-12 bg-gradient-to-br from-primary/10 to-accent/10 border-primary/20">
            <div className="text-center space-y-6">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Join hundreds of businesses using ERPace to streamline their inventory management, reduce costs, and scale efficiently.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} ERPace - Smart Operations Management System. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
