        ...
        <div id={`proforma-print-${invoice.id}`} ref={printRef}>
          ...
          <div className="section terms">
            ...
            <div className="muted" style={{ marginTop: '8px', lineHeight: '1.4', whiteSpace: 'pre-line' }}>
              {businessInfo.defaultPiTerms || `1. Prices are valid until: ${invoice.validUntil ? formatDateIN(invoice.validUntil) : "Further notice"}\n2. All prices are subject to change without prior notice\n3. This is a proforma invoice and not a tax invoice\n4. All rates are inclusive of applicable taxes`}
            </div>
          </div>
    ...
    tempDiv.innerHTML = `
      ...
      <div class="section terms">
        ...
        <div class="muted" style="margin-top: 8px; line-height: 1.4; white-space: pre-line">
          ${escapeHtml(businessInfo.defaultPiTerms || `1. Prices are valid until: ${invoice.validUntil ? formatDateIN(invoice.validUntil) : "Further notice"}\n2. All prices are subject to change without prior notice\n3. This is a proforma invoice and not a tax invoice\n4. All rates are inclusive of applicable taxes`)}
        </div>
      </div>
